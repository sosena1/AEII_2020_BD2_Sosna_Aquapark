...
insert into AQUAPARKATTRACTIONGATEEVENT (eventId, isEntering, date, time, gateId, identificatorId) values (1, 1, '2017-01-09', '6:03', 1, 2);
insert into AQUAPARKATTRACTIONGATEEVENT (eventId, isEntering, date, time, gateId, identificatorId) values (2, 0, '2017-01-09', '18:30', 1, 4);
insert into AQUAPARKATTRACTIONGATEEVENT (eventId, isEntering, date, time, gateId, identificatorId) values (3, 1, '2019-06-19', '20:31', 1, 4);
insert into AQUAPARKATTRACTIONGATEEVENT (eventId, isEntering, date, time, gateId, identificatorId) values (4, 0, '2019-06-19', '13:47', 2, 5);
insert into AQUAPARKATTRACTIONGATEEVENT (eventId, isEntering, date, time, gateId, identificatorId) values (4, 1, '2006-10-08', '15:44', 2, 5);
insert into AQUAPARKATTRACTIONGATEEVENT (eventId, isEntering, date, time, gateId, identificatorId) values (5, 0, '2006-10-08', '8:17', 1, 2);
...
insert into USER (userId, firstName, lastName, address, contactNumber, otherInformation, userName, password, pesel, birthDate, genderId) values (7, 'Jaquelin', 'Reboul', '8 Delaware Junction', '619535243', 's7t6w3P831m33J31271o', 'Bethel', 'YxMnFhSUv630', '42585405712', '2018-07-16', 0);
...
insert into VISIT (visitId, date, startTime, endTime, value, identificatorId, clientId) values (1, '2005-01-09', '6:03', '8:24', 28.56, 4, 3);
insert into VISIT (visitId, date, startTime, endTime, value, identificatorId, clientId) values (2, '2017-11-20', '18:30', '20:01', 19.97, 2, 1);
insert into VISIT (visitId, date, startTime, endTime, value, identificatorId, clientId) values (3, '2019-06-19', '10:31', '12:40', 443.62, 3, 2);
insert into VISIT (visitId, date, startTime, endTime, value, identificatorId, clientId) values (4, '2006-10-08', '13:47', '16:10', 15.18, 4, 2);
insert into VISIT (visitId, date, startTime, endTime, value, identificatorId, clientId) values (5, '2007-10-20', '17:17', '19:07', 31.44, 5, 5);
...
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (1, 'Pool', 174.06, 'Pool price', 1, 4, 1);
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (2, 'Slide', 72.18, 'Slide price', 2, 4, 2);
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (3, 'Pool', 20.00, 'Pool price', 3, 1, 1);
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (4, 'Pool', 5.00, 'Pool price', 3, 2, 1);
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (5, 'Pool', 7.30, 'Pool price', 3, 3, 1);
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (6, 'Pool', 10.20, 'Pool price', 3, 4, 1);
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (7, 'Slide', 30.00, 'Slide price', 3, 1, 2);
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (8, 'Slide', 15.00, 'Slide price', 3, 2, 2);
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (9, 'Slide', 15.00, 'Slide price', 3, 3, 2);
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (10, 'Slide', 15.00, 'Slide price', 3, 4, 2);
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (11, 'Big pool', 20.00, 'Big pool price', 3, 1, 3);
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (12, 'Big pool', 10.20, 'Big pool price', 3, 2, 3);
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (13, 'Big pool', 5.50, 'Big pool price', 3, 3, 3);
insert into PRICELISTITEM (priceListItemId, name, value, description, priceListId, conditionId, attractionId) values (14, 'Big pool', 16.20, 'Big pool price', 3, 4, 3);
...
insert into AQUAPARKATTRACTIONUSAGE (usageId, attractionId, priceListItemId, visitId, enteringEventId, leavingEventId) values (1, 1, 1, 2, 1, NULL);
insert into AQUAPARKATTRACTIONUSAGE (usageId, attractionId, priceListItemId, visitId, enteringEventId, leavingEventId) values (2, 1, 1, 1, 1, 1);
insert into AQUAPARKATTRACTIONUSAGE (usageId, attractionId, priceListItemId, visitId, enteringEventId, leavingEventId) values (3, 2, 2, 1, 1, NULL);
insert into AQUAPARKATTRACTIONUSAGE (usageId, attractionId, priceListItemId, visitId, enteringEventId, leavingEventId) values (4, 2, 2, 1, 1, 1);
insert into AQUAPARKATTRACTIONUSAGE (usageId, attractionId, priceListItemId, visitId, enteringEventId, leavingEventId) values (5, 3, 3, 1, 1, NULL);
insert into AQUAPARKATTRACTIONUSAGE (usageId, attractionId, priceListItemId, visitId, enteringEventId, leavingEventId) values (5, 3, 3, 1, 1, 1);
